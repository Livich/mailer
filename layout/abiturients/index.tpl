...
<head>
    ...
    <style type="text/css">{fetch file="$abiturients_path/style.css"}</style>
...
<!-- body -->
<img src="{$BASE_URL}k.php?uid=%UID%_2405" width="0" height="0" class="hidden no-border">
<div class="wrapper">
    {include file="{$abiturients_path}/header.tpl"}
    <table width="100%">
        ...
        <tr class="body">
            <td colspan="12" class="widget">
                <table class="fill-width">
                    ...
                    <tr class="section navy"><td colspan="2"><h1><img src="{$BASE_URL}shapka.png" class="icon">Цікаве про вступ</h1></td></tr>
                    <tr class="spacer-20"><td colspan="*"></td></tr>
                    <!-- widget 1 -->
                    <tr class="widget transparent">
                        {block name="entrance_1"}{/block}
                    </tr>
                    <!-- /widget 1 -->
                    <tr class="spacer-20"><td></td></tr>
                    <!-- widget 2 -->
                    <tr class="widget transparent">
                        {block name="entrance_2"}{/block}
                    </tr>
                    <!-- /widget 2 -->
                    <tr class="spacer-20"><td></td></tr>
                    <!-- widget 3 -->
                    <tr class="widget transparent">
                        {block name="entrance_3"}{/block}
                    </tr>
                    <!-- /widget 3 -->
                </table>
            </td>
        ...
        <!-- video widget -->
        <tr class="body">
            <td colspan="12" class="widget yellow">
                <h2 style="margin-left:3.333%;">Відеогалерея</h2>

                <table class="fill-width">
                    <tr>
                        <td>
                            {block name="video_1"}{/block}
                        </td>
                        <td>
                            {block name="video_2"}{/block}
                        </td>
                        <td>
                            {block name="video_3"}{/block}
                        </td>
                    </tr>
                </table>
            </td>
